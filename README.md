# แหล่งเรียนรู้เกี่ยวกับด้านคอมพิวเตอร์ ฟรี

```
เรียนอย่างนี้นะครับว่า ตั้งแต่ผมทำ [แฟนเพจ](https://www.facebook.com/programmerthai/) 
ก็ได้เผยแพร่ลิงค์ต่างๆ ที่เป็นความรู้ไว้เยอะมาก 
จึงรู้ว่าความรู้ที่คนไทยเผยแพร่มีเยอะ 
แต่เวลาโพสต์บนเพจ มันไล่หายาก สะเปะสะปะ ไม่เป็นระเบียบ 
ผมเลยถือโอกาจัดรวบรวมเท่าที่ทำได้ ให้ค้นหาได้ง่ายหน่อย 
(ใครมีอะไรแนะนำก็แตก Branch แล้ว commit มาได้เลยครับ)
```

ส่วนใหญ่จะเป็นหนังสือ วีดีโอ ล้วนแจกฟรี  เน้นเป็น __ภาษาไทย__ เป็นหลัก เหมาะกับผู้ศึกษาศาสตร์ทางคอม ที่ภาษาอังกฤษอาจยังไม่แข็งมาในระยะเริ่มต้น โดยเน้นไปทางการเขียนโปรแกรมเป็นหลัก แต่ก็มีภาษาอังกฤษด้วย เผื่อคนสนใจ
...
* [วิดีโอ work shop ของอาจารย์ ผศ. สุชาติ คุ้ม](https://isan.msu.ac.th/suchart/NetworkHowTo/Workshop/)
* [ตัวอย่าง LAB ของอาจารย์ ผศ. สุชาติ คุ้ม](https://isan.msu.ac.th/suchart/NetworkHowTo/LAB/)
